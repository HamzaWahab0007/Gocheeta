...
<div class="container-fluid">
    ...
    <div class="text-right">
        ...
        <button class="btn btn-primary btn-flat bg-gradient-primary" type="button" id="cancel_booking">Cancel Booking</button>
...
<script>
    $(function(){
        ...
        $('#cancel_booking').click(function(){
            _conf("Mark [Ref. Code: <b><?= isset($ref_code) ? $ref_code : "" ?></b>] booking as cancelled?", "update_booking_status",["<?= isset($id) ? $id : "" ?>",4])
        })
    })
